...
def task_part_two(input_dict, output_m3):
    ...
    return {m3: sum(m3_cost_input_dict.values())*m3/sum(output_m3) for m3 in output_m3}
...
if __name__ == "__main__":
    ...
    cost_out = {m3: sum(cost_in)*m3/sum(m3_out) for m3 in m3_out}
    print(cost_out)
    result = task_part_two([{'m3': 1.33, 'cost': 200.1}, {'m3': 2.33, 'cost': 300.1}], [1, 2.5])
    print(result)